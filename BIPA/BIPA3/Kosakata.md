...
| meletus | 爆炸 |
| melibatkan | 涉及，包含；使参与，卷入；包括；参与，介入；纳入 |
...
| pemaparan | 解释；展示，演示 |
| pemasaran | 营销，市场推广；分销，推广；市场营销；配送 |
...
| terbentuk | formed (past participle of form)形成的，已形成的 |
...
| terletak | 位于；坐落于；定位于 |
| terlibat | 参与的，涉及的；投入的，参与其中的；牵涉的，卷入的；牵涉其中的，被牵连的 |
...
| tetangga | 邻居，邻人；邻近的 |
| tetap | 不变的；永久的；仍然；固定的，永恒的；停留，保持；持续的 |
| tikar | 草席，席子；席子材料 |
