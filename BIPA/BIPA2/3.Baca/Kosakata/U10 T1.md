...
| alternatif | 替代，选择；选项；替代品，代替物；解决方案，替代方法 |
| anggap | 认为，考虑；假设，假定；看待，视为；视作 |
| antar | 送，运送；陪伴，送行；护送，陪同；带，送去 |
| beradaptasi | 适应，调整；习惯，适应气候；遵守，符合 |
| berbasis | 基于，以...为基础；以...为核心，以...为中心；以...为根基，扎根于；由...驱动，以...为动力 |
| berdiri | 站立，站着；成立，建立；存在，屹立；升起，矗立 |
| berhenti | 停止，停下；暂停，停顿；放弃，辞职；中止，终止 |
| berkaitan | 相关的，有关的；连接的，有联系的；关联的，联想的；互相关联的，交织的 |
| berminat | 感兴趣的；热衷的，渴望的；愿意的，乐意的；热情的，积极的 |
| berniat | 打算，意图；计划，筹划；目标，旨在；决心，下定决心 |
| bersentuhan | 接触，触碰；碰到；互动，相互作用；擦过，轻触 |
| bijaksana | 明智的，智慧的；谨慎的，慎重的；深思熟虑的，体贴的；明断的，判断正确的 |
| diam | 沉默，安静；寂静；静止，不动；平静，冷静 |
| dihindari | 被避免的，被回避的；被阻止的，被防止的；被躲避的，被逃避的；被逃脱的，被躲开的 |
| disebut | 被称为，叫做；提到，提及；指；命名，称为 |
| gambaran | 描述，说明；图解；概述，概览；印象，概念 |
...
| keputusan | 决定；决议；判决 |
| kertas | 纸；纸张，一页；文件，文档；材料，物质 |
| kesempatan | 机会；可能性，机遇；时机，场合；特权，优待 |
| kisah | 故事，叙述；传说 |
| klasik | 经典的，传统的；古典的；习惯的；永恒的，不受时间影响的 |
| kursi | 椅子；座位；职位，岗位；长椅，板凳 |
| latar | 背景，环境；场景，布景；上下文；画面 |
| lingkungan | 环境，周围；社区，邻里；周边；生态系统，生态环境 |
| lumayan | 不错的，尚可的；相当，还算；适中的，中等的；可以接受的 |
| melewati | 经过，通过；穿过，经历；跳过，略过；超越，超过 |
| memahami | 理解，明白；领会，理解透彻；领悟，抓住（抽象意义）；意识到，体会到 |
...
| memutuskan | 决定，下决心；确定，裁定；解决，决心；裁决，判定 |
| mencatat | 记录；记下，做笔记；匆匆记下；归档 |
| menentukan | 决定，确定；作出选择；定义，界定；影响，决定性作用 |
...
| merangsang | 刺激；挑衅；激发 |
| minat | 兴趣，爱好；热情，激情；热爱；关注，注意力 |
| olah | 加工，处理；培养，改进；管理，经营；提炼，精炼 |
| peduli | 关心，在意；担忧，关注；介意，注意；处理 |
| pula | 也，此外；再次，又；而且，并且；甚至，连 |
| putri | 女儿；公主；女孩，姑娘；女继承人 |
| putus | 断开，中断；结束，终止；中止 |
| sebagian | 部分；一些，某些；一部分，份额；分数，小部分 |
| sebesar | 和...一样大，像...一样大；达到，总计；等同于，相当于；与...成比例，相称的 |
| segala | 所有事物，一切；所有，全部；每一个；任何事物，任何东西 |
| sekelumit | 一点点，少量；一瞥 |
| semester | 学期；时期；课程，阶段 |
| seolah | 仿佛，好像；像，如同；似乎，看起来；假装，装作 |
| serta | 和，以及；连同；还有；与...一起 |
| tengah | 中间，中央；中心，核心；当中，期间；中间立场，折中点 |
| tentu | 确定的，肯定的；明确的；确信的；必然的，不可避免的 |
| teori | 理论；假设，假说；概念，观念；原理，原则 |
| terpaksa | 被迫，强制；不得不；有义务；勉强地，不情愿地 |
